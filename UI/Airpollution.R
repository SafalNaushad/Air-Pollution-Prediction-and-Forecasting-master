                        ...
                        tabPanel("XGBoost",
                                 sidebarLayout(
                                   sidebarPanel(
                                     ...
                                     hr(),
                                     a(href="https://en.wikipedia.org/wiki/Naive_Bayes_classifier", "Extreme Gradient Boosting")
                                   ),
                                   mainPanel(
...
server <- function(input, output, session) {
 ...
 if (input$rfoption =="Importance"){
  ...
  output$text1 <- renderText({
    str1 <- paste("SAFAL P NAUSHAD") 
    str2 <- paste("***********************") 
    str3 <- paste("+91 97471 123901") 
    str4 <- paste("safalnaushad@gmail.com") 
